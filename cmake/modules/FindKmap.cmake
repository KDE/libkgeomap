...
ELSE (KMAP_INCLUDE_DIR AND KMAP_LIBRARIES AND KMAP_DEFINITIONS)
  ...
  IF (KMAP_LOCAL_FOUND)
    ...
    SET(KMAP_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/${KMAP_LOCAL_DIR} ${CMAKE_BUILD_DIR}/${KMAP_LOCAL_DIR})
    SET(KMAP_DEFINITIONS "-I${CMAKE_SOURCE_DIR}/${KMAP_LOCAL_DIR}" "-I${CMAKE_BUILD_DIR}/${KMAP_LOCAL_DIR}")
