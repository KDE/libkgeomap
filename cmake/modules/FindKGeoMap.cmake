...
if (KGEOMAP_INCLUDE_DIR AND KGEOMAP_LIBRARIES AND KGEOMAP_DEFINITIONS AND KGEOMAP_VERSION)
  ...
  if (KGEOMAP_LOCAL_DIR)
    find_file(KGEOMAP_LOCAL_FOUND libkgeomap/version.h.cmake ${CMAKE_SOURCE_DIR}/${KGEOMAP_LOCAL_DIR} NO_DEFAULT_PATH)
    ...
    find_file(KGEOMAP_LOCAL_FOUND libkgeomap/version.h.cmake ${CMAKE_SOURCE_DIR}/libkgeomap NO_DEFAULT_PATH)
    if (KGEOMAP_LOCAL_FOUND)
      set(KGEOMAP_LOCAL_DIR libkgeomap)
    endif (KGEOMAP_LOCAL_FOUND)
    find_file(KGEOMAP_LOCAL_FOUND libkgeomap/version.h.cmake ${CMAKE_SOURCE_DIR}/libs/libkgeomap NO_DEFAULT_PATH)
    if (KGEOMAP_LOCAL_FOUND)
